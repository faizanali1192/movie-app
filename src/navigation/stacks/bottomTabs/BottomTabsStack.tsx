...
const TabBarIcons = {
  ...
  [NavConst.WATCH]: SVG.MovieIcon,
  [NavConst.MEDIA_LIBRARY]: SVG.MediaIcon,
...
export const BottomTabsStack = () => {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen name={NavConst.WATCH} component={MovieStack} />
      <Tab.Screen name={NavConst.MEDIA_LIBRARY} component={MediaStack} />
      <Tab.Screen name={NavConst.MORE} component={MediaStack} />
    </Tab.Navigator>
  );
};
